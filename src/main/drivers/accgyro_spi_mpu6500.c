...
bool mpu6500SpiDetect(void)
{
    ...
    if (tmp == MPU6500_WHO_AM_I_CONST || tmp == MPU9250_WHO_AM_I_CONST || tmp == ICM20601_WHO_AM_I_CONST || tmp == ICM20602_WHO_AM_I_CONST || tmp == ICM20608G_WHO_AM_I_CONST || tmp == ICM20689_WHO_AM_I_CONST) {
        return true;
    }
